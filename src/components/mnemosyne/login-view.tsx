...
export function LoginView() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-10">
      {/* ambient background */}
      <div className="pointer-events-none absolute -top-1/3 left-1/2 h-[50vh] w-[50vh] -translate-x-1/2 rounded-full bg-amber-500/15 blur-[120px]" />
      ...
      >
        ...
        <div className="mb-8 flex flex-col items-center text-center">
          <span className="relative mb-5 grid h-16 w-16 place-items-center rounded-2xl bg-gradient-to-br from-amber-500/25 to-emerald-500/25 ring-1 ring-amber-500/40">
            <Brain className="h-8 w-8 text-amber-500" />
          </span>
          <h1 className="text-2xl font-semibold tracking-tight">{t('login.welcome')}</h1>
          <p className="mt-1 text-[11px] font-medium uppercase tracking-[0.3em] text-amber-500/80">
            MNEMOSYNE AI
          </p>
          ...
          <CardContent className="p-6 sm:p-8">
            <form onSubmit={submit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled={busy}
                    autoComplete="name"
                    className="h-12 w-full rounded-xl border border-input bg-background pl-10 pr-3 text-sm outline-none transition-colors focus:border-amber-500/50 focus:ring-2 focus:ring-amber-500/20"
                  />
                </div>
              </div>
              ...
              <Button
                type="submit"
                disabled={busy}
                className="glow-amber h-12 w-full gap-2 bg-gradient-to-br from-amber-500 to-amber-600 text-base font-semibold text-amber-950 hover:from-amber-400 hover:to-amber-500"
              >
                {busy ? (
                  <>
