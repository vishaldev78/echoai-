...
export function SplashScreen() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background">
      {/* ambient glow */}
      <div className="pointer-events-none absolute -top-1/4 left-1/2 h-[60vh] w-[60vh] -translate-x-1/2 rounded-full bg-emerald-500/20 blur-[120px]" />
      ...
      <div className="relative mb-8 grid place-items-center">
        ...
        <motion.span
          className="relative grid h-20 w-20 place-items-center rounded-2xl bg-gradient-to-br from-emerald-500/25 to-emerald-500/25 ring-1 ring-emerald-500/40"
      ...
      >
        ...
        <p className="mt-1 text-[11px] font-medium uppercase tracking-[0.3em] text-emerald-500/80">AI</p>
